  ...
  class Transport
    ...
    def apply_public_transport_details(transportation)
      transport_details = Com::Igeolise::Traveltime::Rabbitmq::Requests::PublicTransportDetails.new(
        walkingTimeToStation: @details[:walking_time_to_station]
      )
    ...
    def apply_driving_pt_details(transportation)
      ...
      transport_details.walkingTimeToStation = @details[:walking_time_to_station] if @details[:walking_time_to_station]
      transport_details.drivingTimeToStation = @details[:driving_time_to_station] if @details[:driving_time_to_station]
      transport_details.parkingTime = @details[:parking_time] if @details.key?(:parking_time)
